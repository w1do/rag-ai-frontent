...
## Architecture
Обязательно следовать архитектуре `.agents/skills/frontent/astro/architecture.md` придерживаясь CQRS

## Components && UI/Kits
Обязательно следовать инструкциям компонентов создавать переиспользуемые компоненты ориентируясь придерживаясь FSD `.agents/skills/frontent/astro/component.md`
